...
int	main(void)
{
	...
	output_OG = printf("%d\n", 0);
	output_FT = ft_printf("%d\n", 0);
	printf("OUTPUT OG = %d\n", output_OG);
	ft_printf("OUTPUT FT = %d\n", output_FT);
	
	ft_printf("--------------------------------TESTE Negar-------------------------------\n");
	output_OG = printf("%    c\n", 'a');
	...
	ft_printf("\n\n");
	output_OG = printf(NULL);
	output_FT = ft_printf(NULL);
	printf("OUTPUT OG = %d\n", output_OG);
	ft_printf("OUTPUT FT = %d\n", output_FT);

	ft_printf("\n\n");
	output_OG = printf("hello i me very very % very veru vud\n");
	output_FT = ft_printf("hello i me very very % very veru vud\n");
	printf("OUTPUT OG = %d\n", output_OG);
	ft_printf("OUTPUT FT = %d\n", output_FT);
